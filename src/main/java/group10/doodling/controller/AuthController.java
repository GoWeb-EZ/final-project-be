...
public class AuthController {
    ...
    public ResponseEntity<LoginURLResponseDTO> getLoginURL() {
        String loginURL = oAuthManager.createRedirectURI(OAuthManager.OauthType.KAKAO);
    ...
    public ResponseEntity<TokenResponseDTO> login(@RequestParam String code, @RequestParam("redirect_uri") String redirectURI) throws JsonProcessingException {
        ...
        String accessToken = oAuthManager.getAccessToken(OAuthManager.OauthType.KAKAO, code, redirectURI);
        OauthUserInfoResponseDTO oauthUserInfoResponseDTO = oAuthManager.getUserInfoByOauthAPI(OAuthManager.OauthType.KAKAO, accessToken);
